        ...
        <div id="bottom-container">
        	<div id="footer-content">
                ...
                <p>
                <?php if ($info_phone !="") { echo __('Phone ','vulcan') . $info_phone.','; }?> <br>
                ...
                <div id="footer-last">
                  ...
                  <?php 
                    ...
                    <?php echo ($footer_text) ? stripslashes($footer_text) : "Copyright &copy; 2013 Dinâmica.  Todos os direitos reservados";?>
                    </div>
                </div>
