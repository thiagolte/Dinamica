      ...
      'fields' => apply_filters( 'comment_form_default_fields', 
        array(
          'author' => 
                  ...
                  '<input id="author" name="author" type="text" value="' .esc_attr( $commenter['comment_author'] ) . '" size="30" tabindex="1"' . $aria_req . '   class="textfield"/>',
          
          'email'  => 
                  '<label for="email">' . __( 'Email','vulcan' ) . ( $req ? '<span class="required">*</span>' : '' ) . '</label>' .
                  '<input id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30" tabindex="2"' . $aria_req . '  class="textfield" />',
