				...
				$.ajax(
					{
						...
						type: 'POST',
						data: "empresa=" + empresa + "&ramo=" + ramo + "&nome=" + nome + "&telefone=" + telefone + "&celular=" + celular + "&email=" + email + "&duvidas=" + duvidas + "&marcas=" + marcas + "&sendto=" + sendto,
