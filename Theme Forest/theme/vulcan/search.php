        ...
        <div id="content">
        	<div id="content-left">          
                <div class="maincontent">
                    ...
                    $readmoretext = (get_option('vulcan_readmoretext')) ? get_option('vulcan_readmoretext') : __("Leia Mais",'vulcan');
                    ...
                    <div class="warning"><h5><?php echo __('Try different search?');?></h5></div>
                    <?php get_search_form();?>
                    <?php endif;?>
                    <!-- end of blog post -->
                    <div class="clr"></div>
