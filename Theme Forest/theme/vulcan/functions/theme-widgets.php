...
$dynamic_widget_homepage_areas = array(
		/* rename or create new dynamic sidebars */
    "Homepage Column 1",
		"Homepage Column 2",
		"Homepage Column 3"
...
if ( function_exists('register_sidebar') ) {
    foreach ($dynamic_widget_homepage_areas as $widget_area_name) {
        register_sidebar(array(
           'name'=> $widget_area_name,
...
class PostBox_Widget extends WP_Widget {
  ...
  function widget( $args, $instance ) {
    ...
    ?>
      ...
      <p><?php the_excerpt();?><a href="<?php the_permalink();?>" class="readmore"><?php echo __('Leia Mais','vulcan');?></a></p> 
    <?php      
    endwhile;
    echo $after_widget;
  } 
...
class Twitter_Widget extends WP_Widget {
  ...
  function widget( $args, $instance ) {
    ...
    indonez_twitter_feed($twittertitle,$twitternum);
