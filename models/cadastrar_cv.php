...
private $db;
    ...
    */
    ...
    public function set_Cadastro($email, $nome, $senha, $datanascimento, $telefone, $celular, $cpf,
            ...
            $sexo, $CV, $Cat1, $Vag1, $TempoEx1, $Cat2, $Vag2, $TempoEx2, $Cat3, $Vag3, $TempoEx3) {
        ...
        $idCadastro = $this->MySQLIUD(
                ...
                SELECT
                    ...
                    $estadocivil,$sexo,1, '" . $_SERVER["REMOTE_ADDR"] . "'
                ;
                "
        );
    ...
    public function Buscar_Profissionais($sexo, $estado, $AreaInteresse, $faixaEtaria, $cidade, $pretencao){
        $this->db->connect(); 
